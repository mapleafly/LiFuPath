...
(
    ...
    `chinese_score`      DECIMAL(6, 1) COMMENT '语文分数',
    `math_score`         DECIMAL(6, 1) COMMENT '数学分数',
    `english_score`      DECIMAL(6, 1) COMMENT '外语分数',
    `elective_scores`    DECIMAL(6, 1) COMMENT '三科选考分数',
